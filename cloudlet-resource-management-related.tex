...
battery. 
% Such adaption was purely reactive by the mobile device; in
% our context, adaptation for a collection of devices can be centrally
% managed by their cloudlet, with failover to reactive methods as
% needed. 
