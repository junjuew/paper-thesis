...
Figure~\ref{fig:onboard-dnn-speed}, we choose cheap DNNs that can run in
...
duration.  Comparing column 5 of Figure~\ref{fig:early-discard-results} with
column 2 of Figure~\ref{fig:baseline}, we see that all videos in the benchmark
